...
import { productFeaturedReducer, productListReducer, productDetailsReducer, 
    productWishlistReducer, productBestReducer, productCreateReviewReducer, productRelatedReducer } from './Reducers/ProductReducers';
import { userLoginReducer, userRegisterReducer, userDetailsReducer, userUpdateReducer } from './Reducers/UserReducers';
import{ CategoryListReducer,  CategoryDescendantReducer, SingleCategoryListReducer,SingleCategoryListReducer2 } from "./Reducers/CategoruReducers";
...
import { blogDetailReducer, blogDislikeReducer, blogLikeReducer, blogListReducer } from "./Reducers/BlogReducer";
